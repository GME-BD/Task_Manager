...
@section('content')
    <div class="container mb-3">
        ...
        <h2 class="page-header mb-5">
            <i class="bi bi-pencil-square me-2"></i> Editing Employee: <span class="text-primary">{{ $project->name }}</span>
        </h2>

        <div class="card m-auto" style="max-width: 600px;">
            <div class="card-body p-4 p-md-5">

                <h4 class="card-title text-center mb-4 text-secondary">Update Details</h4>
                ...
                <form action="{{ route('projects.update', $project->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        {{-- Use old() for sticky data on failure --}}
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6 mb-4 mb-md-0">
                            ...
                            {{-- Use old() for sticky data and set default to formatted date --}}
                            @php
                                $startDate = \Carbon\Carbon::parse($project->start_date)->format('Y-m-d');
                            @endphp
                    ...
                    <div class="mb-4">
                        ...
                        <select name="status" id="status" class="form-select" required>
                            {{-- Use old() for sticky data, falling back to $project->status --}}
